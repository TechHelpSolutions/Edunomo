  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10">
      ...
      <div className="bg-gradient-to-r from-[#0D2A68] to-[#1E3A8A] rounded-3xl p-6 sm:p-10 text-white mb-8 shadow-sm">
        <div className="max-w-2xl">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 text-xs font-semibold text-sky-200 mb-3 backdrop-blur-md">
            ...
            <span>Global Flight Fares & Travel</span>
          </div>
          <h1 className="text-2xl sm:text-4xl font-extrabold tracking-tight text-white mb-3">
            Flight Booking
          </h1>
          <p className="text-xs sm:text-sm text-slate-200 leading-relaxed">
            Search competitive airfares with leading airlines including British Airways, Air Canada, and Singapore Airlines. Enjoy flexible routes, generous baggage options, and convenient travel reservations for all customers and students alike.
          </p>
        </div>
      </div>
      ...
      <ComingSoonBanner
        ...
        description="Instant GDS airline reservation and flexible ticketing for all travelers are launching in Phase 2."
      />
